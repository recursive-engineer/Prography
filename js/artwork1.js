...
function inputs(artwork){
    ...
    input6_input.addEventListener("mouseleave",function(){
        input6_input.style="background-color: white;border-color: #6610f2;color:#6610f2;";
    });
    ...
    return [input1_input.value,input2_input.value,input3_input.value,input4_input.value,input5_input.value];
}
...
function sierpinski(ctx,center,length,color,recur,limit,settings){
    if(recur<limit){
        ...
        color1.g-=(255-color1.r)/2+Math.floor((Math.random()-0.5)*noise);
        color1.b-=(255-color1.r)/2+Math.floor((Math.random()-0.5)*noise);
        color1.r+=(255-color1.r)/2+Math.floor((Math.random()-0.5)*noise);
        var color2=Object.create(color);
        color2.r-=(255-color2.g)/2+Math.floor((Math.random()-0.5)*noise);
        color2.b-=(255-color2.g)/2+Math.floor((Math.random()-0.5)*noise);
        color2.g+=(255-color2.g)/2+Math.floor((Math.random()-0.5)*noise);
        var color3=Object.create(color);
        color3.r-=(255-color3.b)/2+Math.floor((Math.random()-0.5)*noise);
        color3.g-=(255-color3.b)/2+Math.floor((Math.random()-0.5)*noise);
        color3.b+=(255-color3.b)/2+Math.floor((Math.random()-0.5)*noise);
